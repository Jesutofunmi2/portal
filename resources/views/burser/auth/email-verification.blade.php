...
<div  class="card-header no-border">
    ...
    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Burser Email Verification</span></h6>
...
<script type="text/javascript">
	function sendMail(){
		...
		$.ajax({
                    url: "{{ route('burserEmailVerification') }}",
                    type:"POST",
                    data:{
						user_id : user_id,
                        email : email,
