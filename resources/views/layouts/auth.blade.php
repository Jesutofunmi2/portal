  ...
  <head>
    ...
    <body style="background-color:#{{ env('APP_COLOR') }}"  data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
        ...
        <div  class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
            ...
            <div style="color: #fff; font-size:1.2em; margin:10px; text-align:center;">
              <a href="https://odsgmoest.org.ng/eportal/student-generate-eslip" target="_blank" style="color: #fff;">ONDO STATE DIGITAL QUIZ COMPETITION</a> 
              <hr />
              <a href="{{ route('ministry_login_page') }}" style="color: #fff;">Ministry Login</a> |
              <a href="{{ route('aeo_zeo_login_page') }}" style="color: #fff;">AEO/ZEO Login</a> 
              <hr />
              <a href="{{ route('cas_login_page') }}" style="color: #fff;">CAS Login</a> |
              <a href="{{ route('school_login_page') }}" style="color: #fff;">School Admin Login</a>
              <hr />
              <a href="{{ route('teacher_login_page') }}" style="color: #fff;">Teacher Login</a> |
              <a href="{{ route('student_login_page') }}" style="color: #fff;">Student Login</a>
              <hr />
              <a href="https://odsgmoest.org.ng/eportal/student-data" target="_blank" style="color: #fff;">Get OSSI Number</a>
            </div>
