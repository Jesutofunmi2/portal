...
<section class="ui raised segment" style="max-width: 1200px; margin: 20px auto;box-shadow: 0px 0px 0px transparent !important;border-style: none !important;">
  ...
  @if ($student && $student_voucher)
    <div class="student_reciept" style="background: url('/eportal/public/images/header-logo.png')">
      <table style="width:100%; padding:5px; border:2px solid;">
        <tr >
          ...
          <td width="80%" style="border:1px;">
            <table width="100%">
              ...
              <tr>
                <td>
                  <h2>{{$student->surname}} {{$student->firstname}} {{$student->middlename}}</h2>
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <strong>Pin:</strong> <span>{{$student_voucher->pin}}</span>
                </td>
              </tr>
              <tr>
                <td>
                  <strong>Serial:</strong> <span>{{$student_voucher->serial}}</span>
                </td>
              </tr>
              <tr>
                <td>
                  <strong>Session:</strong> <span>{{$student_voucher->session}}</span>
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <strong>Amount:</strong> <span>₦{{DB::table('payment_items')->first()->cost + 200}}</span>
                </td>
              </tr>
              <tr>
                <td>
                  <small>Reciept was generated {{$student->created_at->diffForHumans()}}</small>
                </td>
              </tr>
            </table>
          </td>
