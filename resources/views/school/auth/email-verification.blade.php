...
@section('title')
	School-Admin Email Verification
@endsection
@section('content')
<div  class="card-header no-border">
    ...
    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>School-Admin Email Verification</span></h6>
	<h6 class="card-subtitle text-muted text-xs-center"><span>Welcome {{ $user['fullname'] }}, please continue to verify your email. You can provide new email if this is no longer accessible. </span></h6>
</div>
...
<script type="text/javascript">
	function sendMail(){
		...
		$.ajax({
                    url: "{{ route('schoolEmailVerification') }}",
                    type:"POST",
                    data:{
						user_id : user_id,
                        email : email,
