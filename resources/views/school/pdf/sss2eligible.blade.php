            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <th colspan="7">{{ strtoupper($state) }} STATE MINISTRY OF EDUCATION, SCIENCE AND TECHNOLOGY</th>
                    </tr>
                    <tr >  
                        <th colspan="7">LIST OF ELIGIBLE STUDENTS FOR EXAMINATION</th>
                    </tr>
                    <tr>   
                        <th colspan="7">SCHOOL: {{ strtoupper($schoolData->name) }}</th>
                    </tr>
                    <tr>
                        <th colspan="7">SCHOOL LGA: {{ strtoupper($school_lga) }}</th>
                    </tr>
                    <tr>
                        <th colspan="2"></th>
