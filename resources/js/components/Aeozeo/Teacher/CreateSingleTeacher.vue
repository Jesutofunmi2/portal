									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="projectinput1">Subject Area</label>
												<multiselect v-model="teacher.subjects" tag-placeholder="Select Subject" :class="{'border-danger':validationErrors.subjects}" placeholder="Select Subject" :options="subjects" :multiple="true" :taggable="true" @tag="addTag" label="subject" track-by="id"></multiselect>
