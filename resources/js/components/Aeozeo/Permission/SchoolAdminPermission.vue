		...
		methods : {
            getAdmins(page =1){
                ...
                if(this.is_term===true){
                    url = '/api/ministry/permission/schoolAdmin/view?query='+this.query+'&page='+page;
                }
                else if(this.is_school_id===true){
                    url = '/api/ministry/permission/schoolAdmin/view?school_id='+this.school_id+'&page='+page;
                }
                else{
                    url = '/api/ministry/permission/schoolAdmin/view?page='+page;
                }
