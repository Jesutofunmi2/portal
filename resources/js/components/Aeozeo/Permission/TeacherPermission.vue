    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Teacher Permission</h4>
                      ...
                      <div v-if="pagination">
                        ...
                        <tbody >
                            ...
                            <tr v-for="(teacher , index) in teachers" :key="index">
                                ...
                                <td>
                                    <button @click="editPermission(teacher.id)" class="btn btn-success"><i class="icon-edit"></i> Edit Permission </button>
                                </td>
                                
                            </tr>
                            <tr v-if="teachers.length==0">
                                <td colspan="4"> Please select Local Govt Area and then School to get Teachers</td>
                            </tr>
...
<script>
    ...
    export default {
		...
		methods : {
           ...
           editPermission(id){
               this.$alert("Sorry, Teacher's permission is not available","Opps!",'question');
            //    this.$confirm("Are you sure you want to edit permission?","Edit Permission",'question').then(() => {
            //     this.$router.push({
            //             name: 'edit-school-admin-permission',
            //             params: { userId: id }
            //             });
            //     });
           }
