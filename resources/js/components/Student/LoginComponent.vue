   ...
   <div>
    ...
    <div class="login-page">
			...
			<fieldset class="form-group position-relative has-icon-left mb-0">
				<input type="text" v-model="regnum" class="form-control form-control-lg input-lg" id="username" placeholder="Your Reg. Number" name="regnum" required autofocus>
...
export default {
    ...
    methods:{
        loginUser(){
             ...
             if(this.regnum==null || this.regnum=='' || this.password==null || this.password==''){
                 this.error_message = 'Username and Password is required';
                 return;
             }
            this.$loading(true);
            let data = new FormData;
			data.append('regnum', this.regnum);
            data.append('password', this.password);
			
				axios.post('/api/student/login',data)
				.then((res) => {
