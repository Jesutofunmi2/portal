		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Upload Results By Subject</h4>
						...
						<form class="form" novalidate @submit.prevent="uploadResults">
							<div class="form-body">
                                ...
                                <div class="form-group col-md-6">
									...
									<select type="text" id="issueinput21" v-model="session" @change="getSubjects" :class="{'border-danger':validationErrors.session}" class="form-control" name="session" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Session" required>
                                ...
                                <div class="form-group col-md-6">
									...
									<select id="issueinput12" v-model="subject_id" @change="getClass" :class="{'border-danger':validationErrors.subject_id}" class="form-control" name="subject_id" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Subject" required>
...
export default {
    ...
    methods: {
        ...
        getClass() {
            this.validationErrors.subject_id = null
            this.$loading(true)
            axios.get(`/api/teacher/subjectclass/${this.subject_id}/${this.session}`)
            .then((res) => {
        ...
        downloadFile() {
            if (!this.session || !this.class_id || !this.classarm_id || !this.term || !this.subject_id) {
                ...
                axios({
                    url: '/api/teacher/result/downloadsubjtemplate',
                    method: 'GET',
                    params: params,
                    responseType: 'blob',
                }).then((response) => {
                        ...
                        let fileName = `studentResultBySubject_${this.class_name}_${subjName}.xls`
        ...
        uploadResults() {
            ...
            axios.post('/api/teacher/result/uploadsubject', data)
            .then(response => {
                if(response) {
                    this.$loading(false)
