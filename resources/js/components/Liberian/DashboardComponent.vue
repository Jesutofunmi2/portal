<template>
    ...
    <div class="">
      ...
      <div   class="col-md-3 col-sm-4 col-xs-12">
          <div style="border-radius: 15px;" class="card">
            <img class="ui fuild image" height="200px" width="100%" src="/images/icons/school-admin-icon.png">
      ...
      <div   class="col-md-3 col-sm-4 col-xs-12">
        <div style="border-radius: 15px;" class="card">
          <img class="ui fuild image" height="200px" width="100%" src="/images/icons/parent.png">
  ...
  <div class="row">
    <div class="">
      ...
      <div   class="col-md-3 col-sm-4 col-xs-12">
          <div style="border-radius: 15px;" class="card">
            <img class="ui fuild image" height="200px" width="100%" src="/images/icons/view-result.png">
            <div style="background-color: rgb(255, 166, 0); padding: 5px; text-align: center;" class="">
  ...
  <div class="row">
    <div class="">
      ...
      <div   class="col-md-3 col-sm-4 col-xs-12">
          <div style="border-radius: 15px;" class="card">
            <img class="ui fuild image" height="200px" width="100%" src="/images/icons/result_checker.png">
            <div style="background-color: rgb(255, 166, 0); padding: 5px; text-align: center;" class="">
      ...
      <div   class="col-md-3 col-sm-4 col-xs-12">
        <div style="border-radius: 15px;" class="card">
          <img class="ui fuild image" height="200px" width="100%" src="/images/icons/elearn-connect.png">
          <div style="background-color: orange; padding: 5px; text-align: center;" class="">
            <h4>e-Learning</h4>
          </div>
        </div>
