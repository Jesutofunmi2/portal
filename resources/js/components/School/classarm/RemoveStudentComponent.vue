            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Remove Student from class</h4>
                    ...
                    <div class="card-body collapse in">
                        ...
                        <div class="card-block card-dashboard row">
                            ...
                            <div v-if="ids.length > 0">
                                <button @click="removeFromClass()" class="btn btn-danger">
                                    <i class="icon-android-send"></i> Remove Student from Class
                                </button>
                            </div>
		...
		methods : {
            ...
            removeFromClass() {
               if(!this.session_s || !this.class_id || !this.class_arm_id || !this.term) {
                ...
                axios.post('/api/school/classarm/remove/student', data)
                .then((res) => {
