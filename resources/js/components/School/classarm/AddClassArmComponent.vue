		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Add Class Arm</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						<form class="form" novalidate @submit.prevent="addClassArm">
							<div class="form-body">

								<div class="form-group col-md-6">
									<label for="issueinput1">Class</label>
									<select id="issueinput1" v-model="classarm.class_id" :class="{'border-danger':validationErrors.class_id}" class="form-control" name="class_id" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Class" required>
    ...
    export default {
		...
		methods : {
			...
			addClassArm(){
				...
				data.append('class_id', this.classarm.class_id);				
				this.$loading(true)

                axios.post('/api/school/classarm/add', data)
				.then(response => {
                    if(response) {
						this.$loading(false)
					...
					this.classarm.class_arm = null;
					this.classarm.class_id = null;
                })
				.catch(error => {
					this.$loading(false)
					if (!error.response) {
