                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <tr v-for="(student , index) in students" :key="index">
                                        ...
                                        <td>{{ student.school2 }}</td>
                                        <td>{{ student.regnum }}</td>
                                        <td>
                                            <span v-if="student.debtor_id !== null">
                                                Student has debt
                                            </span>
                                            <span v-else-if="student.debtor_id === null">
                                                Student has no debt
                                            </span>
                                        </td>
...
<script>
    ...
    export default {
		...
		methods : {
			...
			getStudents($url = '/api/school/transfer/studenthistory') {
                if($url == null) return;
            ...
            searchByTerm() {
				...
				axios.get('/api/school/transfer/studenthistory', { 
                    params: params })
				.then((res) => {
					this.students = res.data.data,
                    this.pagination = res.data.links,
