            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Teacher Inward Transfers</h4>
...
<script>
    ...
    export default {
		...
		methods : {
			getTeachers($url = '/api/school/transfer/teachersinward') {
                if($url==null) return ;
				this.$loading(true);
				axios.get($url)
				.then((res) => {
            ...
            searchByTerm() {
                ...
                this.$loading(true);
				axios.get(`/api/school/transfer/teachersinward?query=${this.query}`)
				.then((res) => {
					this.teachers = res.data.data,
                    this.pagination = res.data.links,
                    this.meta = res.data.meta,
            ...
            confirmTransfer(id) {
                this.$confirm("Do you want to confirm this teacher's transfer?","Confirm Transfer",'question').then(() => {
                    ...
                    axios.post(`/api/school/transfer/teacherconfirm`, data)
                    .then((res) => {
