		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Create Category</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						<form class="form" novalidate @submit.prevent="addCategory">
							<div class="form-body">

								<div class="form-group" >
									<label for="issueinput2">Category Name</label>
    ...
    export default {
		...
		methods : {
			addCategory() {
                ...
                axios.post('/api/school/library/category/add', data)
				.then(response => {
                    if(response) {
						this.$loading(false)
