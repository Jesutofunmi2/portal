		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Edit Book </h4>
						...
						<form class="form" @submit.prevent="updateBook">
							<div class="form-body">
								...
								<div class="form-group col-md-6">
									...
									<textarea id="issueinput6" @keydown="validationErrors.descrip=null" :class="{'border-danger':validationErrors.descrip}" v-model="book.descrip" rows="5" class="form-control" name="descrip" placeholder="Description" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Description"></textarea>
								...
								<div class="form-group col-md-6">
									...
									<input type="text" id="issueinput9" @keydown="validationErrors.serial_no=null" :class="{'border-danger':validationErrors.serial_no}" v-model="book.serial_no" class="form-control" placeholder="Serial Number" name="serial_no" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Serial Number">
...
<script>
    ...
    export default {
		...
		methods : {
			...
			getBook(){
				this.$loading(true)
				axios.get(`/api/school/library/book/${this.bookID}/edit`)
				.then((res) => {
            ...
            updateBook(){
                ...
                axios.post(`/api/school/library/book/${this.bookID}/update`, data)
				.then(response => {
                    if(response) {
						this.$loading(false)
