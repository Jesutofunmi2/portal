		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">School Survey:TeacherQualification </h4>
					
					<SurveyProgress :currentPage="8"></SurveyProgress>
					...
					<div class="card-block">
						...
						<form class="form" novalidate @submit.prevent="submitSurvey">
							<div class="form-body">
								<div class="row">
									<div class="col-md-12">
										<label for="" Style="Font-weight:bold">TEACHERS QUALIFICATION (BY LEVEL AND CLASS) IN CURRENT ACADEMIC YEAR</label> <br>
										<table border="1px" style="border-collapse: collapse;" width="0">
    <tr>
        <th width="200">
            Level of Teaching
        </th>
    ...
    <tr>
        ...
        <td>
            <table border="1px" style="border-collapse: collapse;">
                <tr>
                    <td>
                        <input type="text" size="3" style="height: 30px; width: 100px;">
                    </td>
                    <td>
                        <input type="text" size="3" style="height: 30px; width: 100px;">
                    </td>
    ...
    export default {
		...
		methods : {
			...
			previousStage() {
				...
				this.$router.push({
					name: 'pupilteacher-school-survey',
					params: { surveyId: this.surveyId }
                });
			}
		}
