		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Edit My Profile</h4>
						...
						<form class="form" novalidate @submit.prevent="updateAdmin">
							<div class="form-body">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" @keydown="validationErrors.username=null" :class="{'border-danger':validationErrors.username}" v-model="admin.username" class="form-control"  placeholder="Enter Username" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Enter Username" readonly>
...
<script>
    ...
    export default {
		...
		methods : {
			getAdmin() {
				this.$loading(true);
				axios.get('/api/school/profile/edit')
				.then((res) => {
            ...
            updateAdmin() {
                ...
                axios.post('/api/school/profile/update', data)
				.then(response => {
                    if(response) {
						this.$loading(false)
