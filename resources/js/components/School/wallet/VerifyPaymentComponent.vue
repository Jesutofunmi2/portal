...
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Wallet | Search Student</h4>
            ...
            <div class="card-body collapse in">
                   ...
                   <div class="col-md-3">
                        <fieldset style="width:100%;" class="row py-2">
                            <div class="input-group col-xs-12">
                                <select v-model="s_session"  @change="getClassWallet()" class="form-control form-control-lg input-lg border-grey border-lighten-1" :class="{'border-danger':validationErrors.session}" placeholder="Session"  data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Select Session" required>
                ...
                <div class="table-responsive">
                     <div v-if="wallet"><h4>{{className}} Wallet &gt;&gt; Balance: {{wallet.balance}} | Last Payment: {{wallet.last_payment}}</h4> </div>
                    <table class="table table-striped mb-0">
                        ...
                        <tbody >
                            ...
                            <tr v-for="(student , index) in students" :key="index">
                                <td>
                                    <span v-if="student.is_verified == null">
                                        <label class="toggle-control">
                                ...
                                <td>
                                    <span v-if="student.is_verified" class="text-success"> <strong>Payment Verified</strong> </span>
                                    <button v-else  class="btn btn-success" @click="verifyPayment(student.id)"><i class="icon-check"></i> Verify Payment </button>
                                </td>
                            ...
                            <tr v-if="ids && ids.length > 0">
                                <td colspan="6">
                                    <button class="btn btn-success" @click="bulkVerifyPayment()">Verify Payment</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <Modal v-model="showModal" title="Payment Details"  @close="showModal = false">
        <div>
            <div v-if="success && success.length > 0">
                <div v-for="msg, index in success" :key="index" style="margin: 25px 0px 25px 0px;">
            ...
            <div v-if="error && error.length > 0" >
                <div v-for="msg, index in error" :key="index" style="margin: 25px 0px 25px 0px;">
...
<script>
    ...
    export default {
		...
		methods : {
            ...
            getClassWallet() {
                if(this.validationErrors && this.validationErrors.session) this.validationErrors.session = null;
                ...
                this.$loading(true);
				axios.get('/api/school/class-wallet/show?class_id='+this.class_id+'&session='+this.s_session)
				.then((res) => {
            ...
            verifyPayment(id) {
                ...
                if(this.wallet == null) {
                    this.$alert('No class wallet found', "Wallet Error","error");
                    return;
                }
                ...
                this.$loading(true);
				axios.post('/api/school/class-wallet/verify-payment', {
                                        student_id : id, 
            ...
            bulkVerifyPayment() {
                ...
                this.$loading(true);
				axios.post('/api/school/class-wallet/verify-payment/bulk', {
                                        ids : this.ids, 
                                        class_id : this.class_id,
                                        session : this.s_session,
                                        })
