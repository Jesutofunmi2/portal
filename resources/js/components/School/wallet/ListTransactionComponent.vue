                            ...
                            <div class="col-md-12">
                                <fieldset class="row py-2">
                                    <div class="input-group col-xs-12">
                                        <input v-model="query" type="text" required class="form-control form-control-lg input-lg border-grey border-lighten-1 " placeholder="Search By Title, Description, Amount, or Date" aria-describedby="button-addon2">
...
<script>
    ...
    export default {
		...
		methods : {
			getTransactions($url = '/api/school/transaction/view') {
                if($url == null) return;
            ...
            getWallet($url = '/api/school/wallet/view') {
                if($url == null) return;
            ...
            searchByTerm() {
				...
				axios.get('/api/school/transaction/view', { 
                    params: params })
				.then((res) => {
					this.transactions = res.data.data,
                    this.pagination = res.data.links,
