		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Edit Student</h4>
...
<script>
    ...
    export default {
		...
		methods : {
			...
			getStudent(){
				this.$loading(true);
				axios.get(`/api/school/student/${this.studentId}/edit`)
				.then((res) => {
                    this.student.surname = res.data.data.surname;
                    this.student.firstname = res.data.data.firstname;
                    this.student.middlename = res.data.data.middlename;
                    this.student.dob = res.data.data.dob;
                    this.student.gender = res.data.data.gender;
                    this.student.religion = res.data.data.religion;
                    this.student.class_id = res.data.data.class_id;
                    this.student.class_arm_id = res.data.data.class_arm_id;
                    this.student.parent_fullname = res.data.data.parent_fullname; 
                    this.student.parent_address = res.data.data.parent_address;
                    this.student.parent_email = res.data.data.parent_email;
                    this.student.parent_phone = res.data.data.parent_phone;
                    this.student.session = res.data.data.session;
                    this.student.term = res.data.data.term;
                    this.student.house_id = res.data.data.house_id;
                    this.student.blood_group = res.data.data.blood_group;
                    this.student.lga_id = res.data.data.lga_id;
                    this.student.address = res.data.data.address;
                    this.student.phone = res.data.data.phone;
                    this.student.passport = res.data.data.passport;
            ...
            updateStudent(){
                ...
                if (this.student.parent_email) {
                    data.append('parent_email', this.student.parent_email);
                }
                if (this.student.parent_phone) {
                ...
                axios.post(`/api/school/student/${this.studentId}/update`,data)
				.then(response => {
                    if(response) {
						this.$loading(false)
