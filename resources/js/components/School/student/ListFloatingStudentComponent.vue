            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Floating Students</h4>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <tr v-for="(student , index) in students" :key="index">
                                        ...
                                        <td>
                                            <button @click="editStudent(student.id)"  class="btn btn-primary"><i class="icon-edit"></i> Move </button>
                                        </td>
                                        <td>
...
<script>
    ...
    export default {
		...
		methods : {
			...
			getStudents($url = '/api/school/student/viewfloating') {
                if($url == null) return;
            ...
            searchByTerm() {
				...
				axios.get('/api/school/student/viewfloating', { 
                    params: params })
				.then((res) => {
					this.students = res.data.data,
                    this.pagination = res.data.links,
