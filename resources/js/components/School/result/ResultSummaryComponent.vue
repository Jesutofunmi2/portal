                        ...
                        <div class="card-block card-dashboard row">
                            ...
                            <form class="form" novalidate @submit.prevent="getStudentResults">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="issueinput4">Status</label>
                                        <select type="text" rea id="issueinput4" v-model="status" @change="validationErrors.status=null" :class="{'border-danger':validationErrors.status}" class="form-control" name="term" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Status" required>
                                ...
                                <div class="form-actions pl-1">
                                    <button type="submit" class="btn btn-success">
                                        <i class="icomoon icon-file-pdf"></i> Download Result Summary
                                    </button>
                                </div>
...
<script>
    ...
    export default {
		...
		methods : {
            getStudentResults() {
                const $url = '/api/school/result/summary';
                if (!this.s_session || !this.class_id || !this.classarm_id || !this.status) {
                    this.flashMessage.error({title: 'Incomplete Data Supplied', 
                            message: 'Please select a Class, a Class Arm, a Session, and a Status',
                            time: 15000, });
                } else {
