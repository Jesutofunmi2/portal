            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Session Broadsheet</h4>
...
<script>
    ...
    export default {
		...
		methods : {
            getStudentResults() {
                const $url = '/api/school/result/sessionbroadsheet';
                if (!this.s_session || !this.class_id || !this.classarm_id) {
                    this.flashMessage.error({title: 'Incomplete Data Supplied', 
                            message: 'Please select a Class, a Class Arm, and a Session',
                            time: 15000, });
                } else {
