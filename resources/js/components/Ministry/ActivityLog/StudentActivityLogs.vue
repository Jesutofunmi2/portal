                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <div class="p-2 media-body">
                                        <div class="row">
                                             <h5 > <span style="text-transform:capitalize;"><strong class="text-success">{{fullname}}</strong> - {{log.message}}</span> {{log.created_at}}</h5>
                                         </div>
    ...
    export default {
		...
		methods : {
            getLogs(page = 1) {
                ...
                let url = '/api/ministry/activities-log/student/'+this.adminId+'?page='+page;
