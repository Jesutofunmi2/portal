    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Ministry Activities Log</h4>
                                ...
                                <div class="media">
                                    ...
                                    <div class="p-2 media-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="javascript:void(0)" @click="viewLogs(log.super_admin_id)">View Activity Logs</a>
                                            </div>
                                        </div>
    ...
    export default {
		...
		methods : {
            getLogs(page = 1) {
                ...
                let url = '/api/ministry/activities-log/ministry?page='+page;
            ...
            viewLogs(id){
                this.$router.push({
                        name: 'view-ministry-activities-log',
                        params: { adminId: id }
                        });
            },
