    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Student Activities Log</h4>
                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <div class="p-2 media-body">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <h5 > <span style="text-transform:capitalize;"><strong class="text-success">{{log.surname}} {{log.firstname}} {{log.middlename}}</strong> - {{log.message}}</span> {{log.created_at}}</h5>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="javascript:void(0)" @click="viewLogs(log.student_id)">View Activity Logs</a>
                                            </div>
                                        </div>
    ...
    export default {
		...
		methods : {
            getLogs(page = 1) {
                ...
                let url = '/api/ministry/activities-log/student?page='+page;
            ...
            viewLogs(id){
                this.$router.push({
                        name: 'view-student-activities-log',
                        params: { adminId: id }
                        });
            },
