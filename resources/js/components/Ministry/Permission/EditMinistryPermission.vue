...
<script>
    ...
    export default {
		...
		methods : {
            getPermissions(){
				this.$loading(true);
				axios.get('/api/ministry/permission/ministryAdmin/getPermission?id='+this.userId)
				.then((res) => {
           ...
           toggleAll(){
              let state = null;
               ...
               axios.post('/api/ministry/permission/ministryAdmin/permission/all', data)
				.then((res) => {
           ...
           toggle(id){
               ...
               axios.post('/api/ministry/permission/ministryAdmin/permission/some', data)
				.then((res) => {
