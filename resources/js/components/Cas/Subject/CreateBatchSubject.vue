		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Subject Batch Registration</h4>
					...
					<div class="card-block">
						...
						<form class="form" novalidate @submit.prevent="createSubject">
							<div class="form-body">
								...
								<h4 class="form-section"><i class="icon-head"></i>Subject File</h4>
								<div class="row">
									...
									<div class="col-md-3">
											<fieldset style="width:100%;" class="row py-2">
												<div class="input-group col-xs-12">
													<button @change="onFileChange" type="submit" style="width:100%; background:#FF8C00; color:#fff;" class="btn btn-lg">Register</button>
												</div>
											</fieldset> 
									</div>
								</div>
	...
	components: {
		...
		methods : {
            ...
            createSubject(){
				...
				data.append('batch_file', this.batch_file);
		
				this.$loading(true)

                axios.post('/api/ministry/subject/create/batch',data)
				.then(response => {
                    if(response) {
						this.$loading(false)
