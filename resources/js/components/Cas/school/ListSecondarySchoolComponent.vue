    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List Secondary School</h4>
                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            <tr v-for="(school , index) in schools" :key="index">
                                ...
                                <td>{{ school.name }}</td>
                                <td><img alt="" :src="baseUrl+school.logo" style="max-heigth:100px; max-width:100px;"  /> </td>
                                <td>{{ school.lga }}</td>
		...
		methods : {
            ...
            getSchools(page = 1){
                ...
                if(this.is_term===true){
                    url = '/api/ministry/school/secondary/view?query='+this.query+'&page='+page;
                }
                else if(this.is_lga_id===true){
                    url = '/api/ministry/school/secondary/view?lga_id='+this.lga_id+'&page='+page;
                }
                else{
                    url = '/api/ministry/school/secondary/view?page='+page;
                }
            ...
            editSchool(id){
                ...
                this.$router.push({
                        name: 'cas-edit-secondary-school',
                        params: { schoolID: id }
                        });
                });
            },
            ...
            deleteSchool(id){
                ...
                this.$loading(true)
                axios.delete('/api/ministry/school/secondary/'+id+'/delete')
                .then((response) => {
                    this.$loading(false);
