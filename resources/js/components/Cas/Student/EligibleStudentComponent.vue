                        ...
                        <div class="card-block card-dashboard row">
                            ...
                            <form class="form" novalidate @submit.prevent="getStudents()">
                                ...
                                <div class="col-md-3">
                                    <fieldset style="width:100%;" class="row py-2">
                                        <div class="input-group col-xs-12">
                                            <select  type="text" @change="getClasses()" v-model="school_id" class="form-control form-control-lg input-lg border-grey border-lighten-1" placeholder="Select School" :class="{'border-danger':validationErrors.school_id}"  data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Select School" required>
                                ...
                                <div class="col-md-3">
                                    <fieldset style="width:100%;" class="row py-2">
                                        <div class="input-group col-xs-12">
                                             <select id="issueinput1" v-model="class_id" :class="{'border-danger':validationErrors.class_id}" class="form-control form-control-lg input-lg border-grey border-lighten-1" name="class_id" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Class" required>
                                ...
                                <div class="col-md-3">
                                    <fieldset style="width:100%;" class="row py-2">
                                        <div class="input-group col-xs-12">
                                             <select type="text" id="issueinput3" v-model="session_s" @change="students=''" :class="{'border-danger':validationErrors.session}" class="form-control form-control-lg input-lg border-grey border-lighten-1" name="session" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Session" required>
    ...
    export default {
		...
		methods : {
			...
			getStudents(type = 'show') {
                ...
                if (this.session_s == '' || this.class_id == '' || this.school_id == '') {
                    this.flashMessage.error({title: 'Incomplete Data Supplied', 
                            message: 'Please select a Schoo, Class and a Session.',
                            time: 15000, });
                    return ;
                }
				...
				this.$loading(true);
				axios.get(`/api/ministry/student/eligible`, {params: params})
				.then((res) => {
					if(type == 'show') {
            ...
            getClasses() {
                ...
                if (!this.school_id || this.school_id == '') {
                    this.flashMessage.error({title: 'Incomplete Data Supplied', 
                ...
                axios.get('/api/ministry/student/eligible/classes', {params: params})
                .then((res) => {
