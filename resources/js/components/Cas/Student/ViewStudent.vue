                ...
                <div class="table-responsive">
                     <h4>Student Personal Information</h4>
                        <div>
                            ...
                            <div v-if="students && school_id && class_id && class_arm_id && s_session && term" style="float: right">
    ...
    export default {
		...
		methods : {
            ...
            printNorminalRoll(){
                ...
                axios.get(`/api/ministry/student/norminal-roll/download`, {params: params})
                .then((response) => {
                    this.$loading(false);
