...
class UnityExam extends Authenticatable
{
    protected $table = 'unity_exams';

    protected $guard = 'unity_exam';
    ...
    public function hall_allocation(){
        return $this->hasOne('App\Models\UnityHallAllocation', 'candidate_id');
    }
